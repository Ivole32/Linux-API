...
DEFAULT_API_KEY = "my-test-key"

def verify_api_key(x_api_key: str = Header(DEFAULT_API_KEY, description="Debug API key"), required_role: str = "user"):
...
def get_user_role(required_role: str):
    def dependency(x_api_key: str = Header(DEFAULT_API_KEY, description="Debug API key")):
